  ...
  return (
    <div className={`w-full text-xs flex flex-col gap-1 ${className ?? ""}`}>
      ...
      <textarea
        ...
        className={`px-3 py-2 border rounded-md text-neutral-800 focus:outline-none focus:ring-2 focus:ring-blue-400 placeholder:text-neutral-400 placeholder:text-xs transition-all ${fieldState.error
